...
# Keep your Position class fpr De/Serializing from json
-keep class com.example.scotlandyardlive.Position { <fields>; }
-keep class com.example.scotlandyardlive.Team { <fields>; }

# google keep rules for correct API access
